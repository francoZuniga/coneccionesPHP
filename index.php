...
<body>
    ...
    <nav class="menu">
      <ul>
        ...
        <li class="submenu"><a href="#">Productos<i class="fa fa-caret-down"></i></a>
					<ul>
            <li><a href="productos.php?tipo=accesorios&busqueda=">Accesorios</a></li>
            <li><a href="productos.php?tipo=audio&busqueda=">Audio</a></li>
						<li><a href="productos.php?tipo=variedad&busqueda=">Variedad</a></li>
          </ul>
				</li>
      </ul>
    </nav>
  ...
  <section>
		<!-- tomi arma el slider denuevo porfa-->
  </section>
	<footer>
		<div>
