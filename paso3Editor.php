...
<body>
  ...
  <section>
    ...
    <form onsubmit="return validar()" enctype="multipart/form-data" action="subirImagenesProductosEdicion.php" method="post">
      <div class="bloque">
    ...
    <a href="session.php"><button>terminar</button></a>
  </section>
</body>
</html>
